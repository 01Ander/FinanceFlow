...
transaction1 = Transaction('13/11/2025', 15000, 'Salary', 'income', my_account)
transaction1.apply()
print(f'Transaction 1 done. New balance: {my_account.balance}')
transaction2 = Transaction(
    '14/11/2025', 200, 'Netflix', 'expense', my_credit_card)
transaction2.apply()
print(f'Transaction 2 done. New debit: {my_credit_card.current_debt}')
transaction3 = Transaction('14/11/2025', 1200, 'Shoes', 'expense', my_account)
transaction3.apply()
print(f'Transaction 3 done. New balance :{my_account.balance}')
transaction4 = Transaction(
    '14/11/2025', 1200, 'Shoes', 'expense', my_credit_card)
transaction4.apply()
print(f'Transaction 4 done. New debit :{my_credit_card.current_debt}')
transaction5 = Transaction(
    '25/11/2025', 1400, 'Pay credit card', 'pay_credit', my_credit_card)
transaction5.apply()
print(
